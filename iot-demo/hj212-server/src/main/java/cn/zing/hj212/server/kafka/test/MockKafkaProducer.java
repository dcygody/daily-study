package cn.zing.hj212.server.kafka.test;
 ...
 * @description:
 * @author: dcy
 * @create: 2023-08-23 09:18
 */
public class MockKafkaProducer {

    public static final String brokerList = "192.168.198.133:9092";
    public static final String topic = "hj212-topic";
    ...
    public static Properties initProperties(){
         ...
         */
        prop.put(ProducerConfig.CLIENT_ID_CONFIG,"hj212-producer-1");
        return prop;
    }
    ...
    public static void main(String[] args) {
        ...
        //2. 创建待发送的消息记录
        String data = "##0122QN=20230823092837664;ST=22;CN=2011;PW=123456;MN=D111;Flag=6;CP=&&DataTime=20230823092837;w00000-Rtd=11.76,w00000-Flag=N;&&E041\r\n";
