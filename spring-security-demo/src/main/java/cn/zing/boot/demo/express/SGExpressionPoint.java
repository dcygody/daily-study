package cn.zing.boot.demo.express;
 ...
 * @description: 自定义权限
 * @author: dcy
 * @create: 2023-07-08 17:30
 */
@Component("sg")
@Slf4j
public class SGExpressionPoint {
...
//        PermissionContextHolder.setContext(permissions);
    ...
    public boolean hasRole(String role) {
        ...
        LoginUser loginUser = SecurityUtils.getLoginUser();
        if (StringUtils.isNull(loginUser) || CollectionUtils.isEmpty(loginUser.getUserInfo().getRoles())) {
            return false;
        }
        for (SysRole sysRole : loginUser.getUserInfo().getRoles()) {
